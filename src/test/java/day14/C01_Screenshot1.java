...
//        NOTE: kayit ismini dinamik yapmak icin date objesi kullandim
        ...
        String path = System.getProperty("user.dir")+"/test-output/Screenshots1/"+currentDate+"image.png";
//        String path = System.getProperty("user.dir")+"\\test-output\\EkranGruntfile\\image.png";//CALISMIYORSA WINDOW ICIN
